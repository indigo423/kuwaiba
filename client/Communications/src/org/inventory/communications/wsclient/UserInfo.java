 ...
 *         &lt;element name="groups" type="{http://ws.kuwaiba.org/}groupInfoLight" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends UserInfoLight
{
    ...
    protected List<GroupInfoLight> groups;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<GroupInfoLight> getGroups() {
        if (groups == null) {
            groups = new ArrayList<GroupInfoLight>();
        }
        return this.groups;
    }
