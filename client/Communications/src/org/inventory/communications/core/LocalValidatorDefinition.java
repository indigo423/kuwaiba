 ...
 */
public class LocalValidatorDefinition {
    /**
    ...
    public LocalValidatorDefinition(long id, String name, String description, String classToBeApplied, String script, boolean enabled) {
        this.id = id;
        this.name = name;
