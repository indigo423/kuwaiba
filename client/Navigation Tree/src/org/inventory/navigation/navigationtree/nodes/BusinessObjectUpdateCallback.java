...
/**
 * Handles the updates to regular inventory objects.
 * @author Charles Edward Bedon Cortazar {@literal <charles.bedon@kuwaiba.org>}
 */
public class BusinessObjectUpdateCallback<T> implements UpdateObjectCallback<T> {
    ...
    public void executeChange(String objectClassName, String id, String propertyName, T value) throws IllegalArgumentException {      
        ...
        if (!CommunicationsStub.getInstance().updateObject(objectClassName, id, attributesToBeUpdated))
