/**
 * Displays the connection status in ODF and DDFs. It can also be used un splice boxes with a few modifications.
...
// Business Entity Manager. It is part of the Persistence API, a comprehensive API to manipulate and query inventory information.
...
def portsInDistributionFrame = bem.getChildrenOfClass(objectId, objectClassName, 
                                    ...
                                    -1 /* Retrieve all results at once */ )
