...
//    Connection connection;
    ...
    public NodeMarkerDragListener(Connection connection, ControlPointMarkerDragListener dragListener) {
        ...
        if (draggedMarker instanceof NodeMarker) {
            ...
            for (Connection connection : nodeMarker.getConnections()) {
                if (((NodeMarker) draggedMarker).equals(connection.getSource())) {
                    ...
                    ControlPointMarker sourceControlPoint = new ControlPointMarker(draggedMarker.getPosition());
