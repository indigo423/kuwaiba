...
public class GISView extends CustomComponent {
    ...
    public GISView(final EventBus eventBus, VaadinSession session) {   
        ...
        PopupConnectionWizardView popupView = new PopupConnectionWizardView();
        googleMap.addMarkerClickListener(new NodeMarkerClickListener(popupView, edges, googleMap, session, eventBus));
...
//                mapPolygon.setPolygon(newPolygon);
        ...
        mapLayout.addComponent(popupView);
