...
import org.kuwaiba.wizard.conecction.PopupConnectionWizardView;
...
public class NodeMarkerClickListener implements MarkerClickListener {
    ...
    PopupConnectionWizardView popupView;
    
    public NodeMarkerClickListener(PopupConnectionWizardView popupView, List<Connection> edges, GoogleMap googleMap, VaadinSession session, final EventBus eventBus) {
