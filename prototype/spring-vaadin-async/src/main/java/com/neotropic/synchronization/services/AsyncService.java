...
public class AsyncService {
    ...
    @Async
    public CompletableFuture<List<Person>> createPeople() {
        for (int i = 0; i < 1000; i++) {
            ...
            person.setEmail(person.getFirstName().toLowerCase() + "." + person.getLastName().toLowerCase() + "@example.com");
        ...
        return CompletableFuture.completedFuture(new ArrayList<>(persons));
    }
}
