 ...
 */
@Named("SnmpConfigProcessor")
public class SnmpLeafProcessor implements ItemProcessor {
    
    @Override
    public Object processItem(Object item) throws Exception {
//        System.out.println(">>> SnmpLeafProcessor::processItem ");
        ...
        if (item != null) {
            ...
            return client.getAsString(new OID(config.getOid()));
        }
        return null;            
    }    
}
