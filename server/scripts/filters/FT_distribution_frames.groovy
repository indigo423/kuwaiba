/** 
 * Retrieves all the distribution frames (ODFs, DDFs/MDFs) within a given parent.
 * Neotropic SAS - version 1.1
 * Applies to: Any, preferably GenericPhysicalNode (facilities like buildings or towers) or its subclasses.
 */
...
public class %s extends Filter {
    ...
    public List<BusinessObjectLight> run(String objectId, String objectClass, HashMap<String, String> parameters, int page, int limit) throws InvalidArgumentException {
        def classNameToFilter = "GenericDistributionFrame"
