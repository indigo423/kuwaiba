 ...
 */
@Component
public class RelateObjectToFavoritesFolderAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "favorites-folder.relate-object";
        this.displayName = ts.getTranslatedString("module.favorites.actions.favorite-add-objects-to-favorite.name");
        this.description = ts.getTranslatedString("module.favorites.actions.favorite-add-objects-to-favorite.description");
        setCallback((parameters) -> {
            try {
                ...
                aem.addObjectTofavoritesFolder(object.getClassName(), object.getId(),
