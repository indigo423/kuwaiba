 ...
 */
package org.neotropic.kuwaiba.core.notifications.connection.strategies;

import org.neotropic.kuwaiba.core.i18n.TranslationService;
import org.neotropic.kuwaiba.core.notifications.NotificationType;
import org.neotropic.kuwaiba.core.notifications.connection.strategies.impl.EmailConnectionStrategy;
...
public class ConnectionStrategyFactory {
    ...
    public ConnectionStrategyFactory(TranslationService ts) {
        this.ts = ts;
    }
     ...
     * @return the connection strategy to be used
     * @throws NotificationTypeException Exception thrown if notification type does not exist
     */
    public ConnectionStrategyInterface getConnectionStrategy(NotificationType type) throws NotificationTypeException {
        switch (type) {
            case EMAIL:
                return new EmailConnectionStrategy(ts);
            default:
