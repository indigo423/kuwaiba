...
public class NewClassVisualAction extends AbstractVisualAction<Dialog> {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        if (parameters.containsKey(PARAM_CLASS)) {
            ...
            ConfirmDialog wdwAdd = new ConfirmDialog(ts, String.format(
                    ts.getTranslatedString("module.datamodelman.actions.new-class-for"),
                    parentClass.getName()));
                ...
                try {
                    if (txtName.getValue() == null || txtName.getValue().trim().isEmpty()) {
                        ...
                        fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                                ...
                                ts.getTranslatedString("module.datamodelman.actions.new-class-created-success"),
                                NewClassAction.class, actionResponse));
