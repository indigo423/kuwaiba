 ...
 */
@Component
public class DeletePhysicalContainerVisualAction extends AbstractDeleteAction {
     ...
     */
    @Autowired
    private DeletePhysicalContainerAction deletePhysicalContainerAction;
    
    public DeletePhysicalContainerVisualAction() {
    ...
    public  Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        wdwDelete.getBtnConfirm().addClickListener(event -> {
            try {
                deletePhysicalContainerAction.getCallback().execute(new ModuleActionParameterSet(
                        new ModuleActionParameter<>(DeletePhysicalContainerAction.PARAM_OBJECT_CLASS_NAME, businessObject.getClassName()),
                        new ModuleActionParameter<>(DeletePhysicalContainerAction.PARAM_OBJECT_ID, businessObject.getId())
                ));
                ...
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ...
                        DeletePhysicalContainerAction.class, actionResponse));

            } catch (ModuleActionException ex) {
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ActionCompletedListener.ActionCompletedEvent.STATUS_ERROR,
                        ex.getMessage(), DeletePhysicalContainerVisualAction.class)
                );
                wdwDelete.close();
            }
    ...
    public AbstractAction getModuleAction() {
        return deletePhysicalContainerAction;
    }
    
    @Override
    public String appliesTo() {
        return Constants.CLASS_GENERICPHYSICALCONTAINER;
    }
}