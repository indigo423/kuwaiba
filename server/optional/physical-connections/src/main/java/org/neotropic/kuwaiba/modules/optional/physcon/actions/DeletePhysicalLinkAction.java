 ...
 */
@Component
public class DeletePhysicalLinkAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "delete-physical-link";
        this.displayName = ts.getTranslatedString("module.physcon.actions.delete-physical-link.name");
        this.description = ts.getTranslatedString("module.physcon.actions.delete-physical-link.description");
        this.order = 1000;
