...
public class RemoteBusinessObjectList implements  Serializable {
    private List<RemoteBusinessObject> list;

    public RemoteBusinessObjectList() {
        list = new ArrayList<>();
    }
    
    public boolean add(RemoteBusinessObject element) {
        return list.add(element);
    }
    
    public boolean remove(RemoteBusinessObject element) {
        return list.remove(element);
    }
    
    public List<RemoteBusinessObject> getList() {
        return list;
    }
}