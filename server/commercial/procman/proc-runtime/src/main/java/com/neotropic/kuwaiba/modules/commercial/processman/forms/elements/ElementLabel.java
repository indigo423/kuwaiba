...
/**
 * POJO wrapper of a <b>label</b> element in a Form Artifact Definition
 * @author Johny Andres Ortega Ruiz {@literal <johny.ortega@kuwaiba.org>}
 */
public class ElementLabel extends AbstractElementField<String> {
    ...
    public void initFromXML(XMLStreamReader reader) throws XMLStreamException {
        ...
        String strValue = getValueAttributeValue();
