 ...
 */
@Component
public class DeleteSdhTributaryLinkVisualAction extends AbstractDeleteAction {
     ...
     */
    @Autowired
    private DeleteSdhTributaryLinkAction deleteSdhTributaryLinkAction;

    public DeleteSdhTributaryLinkVisualAction() {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        ConfirmDialog wdwDelete = new ConfirmDialog(ts, getModuleAction().getDisplayName(),
                String.format(ts.getTranslatedString("module.sdh.actions.delete-tributary-link.confirmation-message"),
                        businessObject));
        ...
        wdwDelete.getBtnConfirm().addClickListener(event -> {
            try {
                deleteSdhTributaryLinkAction.getCallback().execute(new ModuleActionParameterSet(
                        new ModuleActionParameter<>(DeleteSdhTributaryLinkAction.PARAM_OBJECT_CLASS_NAME, businessObject.getClassName()),
                        new ModuleActionParameter<>(DeleteSdhTributaryLinkAction.PARAM_OBJECT_ID, businessObject.getId())
                ));
                ...
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ...
                        ts.getTranslatedString("module.sdh.actions.delete-tributary-link.success"),
                        DeleteSdhTributaryLinkAction.class, actionResponse));

            } catch (ModuleActionException ex) {
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ActionCompletedListener.ActionCompletedEvent.STATUS_ERROR,
                        ex.getMessage(), DeleteSdhTributaryLinkVisualAction.class)
                );
                wdwDelete.close();
            }
    ...
    public AbstractAction getModuleAction() {
        return deleteSdhTributaryLinkAction;
    }
    ...
    public String appliesTo() {
        return "GenericSDHTributaryLink"; //NOI18N
    }
}