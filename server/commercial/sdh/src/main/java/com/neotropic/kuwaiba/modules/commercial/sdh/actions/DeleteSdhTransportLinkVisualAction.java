 ...
 */
@Component
public class DeleteSdhTransportLinkVisualAction extends AbstractDeleteAction {
     ...
     */
    @Autowired
    private DeleteSdhTransportLinkAction deleteSdhTransportLinkAction;
    
    public DeleteSdhTransportLinkVisualAction() {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        ...
        ConfirmDialog wdwDelete = new ConfirmDialog(ts, getModuleAction().getDisplayName(),
                String.format(ts.getTranslatedString("module.sdh.actions.delete-transport-link.confirmation-message"),
                        businessObject));
        ...
        wdwDelete.getBtnConfirm().addClickListener(event -> {
            try {
                deleteSdhTransportLinkAction.getCallback().execute(new ModuleActionParameterSet(
                        new ModuleActionParameter(DeleteSdhTransportLinkAction.PARAM_OBJECT_CLASS_NAME, businessObject.getClassName()),
                        new ModuleActionParameter(DeleteSdhTransportLinkAction.PARAM_OBJECT_ID, businessObject.getId())
                ));
                ...
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ...
                        ts.getTranslatedString("module.sdh.actions.delete-transport-link.success"),
                        DeleteSdhTransportLinkAction.class, actionResponse));
                
            } catch (ModuleActionException ex) {
                fireActionCompletedEvent(new ActionCompletedListener.ActionCompletedEvent(
                        ActionCompletedListener.ActionCompletedEvent.STATUS_ERROR,
                        ex.getMessage(), DeleteSdhTransportLinkVisualAction.class)
                );
                wdwDelete.close();
            }
    ...
    public AbstractAction getModuleAction() {
        return deleteSdhTransportLinkAction;
    }   

    @Override
    public String appliesTo() {
        return "GenericSDHTransportLink"; //NOI18N
    }
}