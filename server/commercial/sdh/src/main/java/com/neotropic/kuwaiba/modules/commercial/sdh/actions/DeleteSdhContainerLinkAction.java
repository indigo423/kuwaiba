 ...
 */
@Component
public class DeleteSdhContainerLinkAction extends AbstractAction {
    ...
    @PostConstruct
    protected void init() {
        this.id = "delete-container-link";
        this.displayName = ts.getTranslatedString("module.sdh.actions.delete-container-link.name");
        this.description = ts.getTranslatedString("module.sdh.actions.delete-container-link.description");
        this.order = 1000;
        ...
        setCallback(parameters -> {
            try {
                ...
                sdhService.deleteSDHContainerLink(className, objectId, true);
