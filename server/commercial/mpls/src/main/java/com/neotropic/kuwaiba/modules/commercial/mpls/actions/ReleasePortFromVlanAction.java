 ...
 */
@Component
public class ReleasePortFromVlanAction extends AbstractAction {
    /**
    ...
    @PostConstruct
    protected void init() {
        this.id = "mpls.release-from-vlan";
        this.displayName = ts.getTranslatedString("module.mpls.actions.release-port-from-vlan.name");
        this.description = ts.getTranslatedString("module.mpls.actions.release-port-from-vlan.description");
        ...
        setCallback((parameters) -> {
            ...
            try {
                mplsService.releasePortFromVlan(
                        port.getClassName(),
                        port.getId(),
                        vlan.getClassName(),
                        vlan.getId()
