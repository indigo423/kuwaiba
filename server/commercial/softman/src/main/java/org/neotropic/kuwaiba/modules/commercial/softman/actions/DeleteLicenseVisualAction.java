...
public class DeleteLicenseVisualAction extends AbstractVisualAction<Dialog> {
    ...
    public Dialog getVisualComponent(ModuleActionParameterSet parameters) {
        if (parameters.containsKey("license")) {
            ...
            ConfirmDialog wdwDelete = new ConfirmDialog(ts, this.getModuleAction().getDisplayName(),
                    String.format(ts.getTranslatedString("module.softman.actions.delete-license.confirm"),
                            license.getName()));
